...
const PRESETS: Record<string, Preset[]> = {
  Files: [
    ...
    },
    {
      ...
      command: '"C:\\Users\\%USERNAME%\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe" "%1"',
          ...
          <>
            <div className="space-y-4">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 text-xs text-blue-300">
                <p className="mb-1">
                  <strong className="text-blue-200">Tip:</strong> Use <code className="bg-blue-900/30 px-1 rounded">%1</code> for {location === "Background" ? "the folder path" : "selected file/folder path"}
                </p>
